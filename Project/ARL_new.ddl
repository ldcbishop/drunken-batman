...
DROP TABLE ARL_Admin CASCADE CONSTRAINTS ;
...
CREATE TABLE ARL_Admin
  ( ARL_Employee_employee_id INTEGER NOT NULL
  ) ;
ALTER TABLE ARL_Admin ADD CONSTRAINT ARL_Admin_PK PRIMARY KEY ( ARL_Employee_employee_id ) ;
...
ALTER TABLE ARL_Admin ADD CONSTRAINT ARL_Admin_ARL_Employee_FK FOREIGN KEY ( ARL_Employee_employee_id ) REFERENCES ARL_Employee ( employee_id ) ;
